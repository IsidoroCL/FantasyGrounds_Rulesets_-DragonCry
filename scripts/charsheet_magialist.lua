...
function onSortCompare(w1, w2)
	local name1 = string.lower(w1.nivelmagia.getValue());
	local name2 = string.lower(w2.nivelmagia.getValue());
	local loc1 = string.lower(w1.orbemagia.getValue());
	local loc2 = string.lower(w2.orbemagia.getValue());
